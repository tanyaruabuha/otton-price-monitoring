...
<div class="container">
    <div class="row justify-content-center" style="margin-top: 25%;">
        <div class="col-md-8">
{{--            <div class="card">--}}
{{--                <div class="card-header" style="background-color: #212529; color:white; ">{{ __('Login') }}</div>--}}
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-md-4 col-form-label text-md-right"  style="color: whitesmoke">{{ __('Username') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-4 col-form-label text-md-right" style="color: whitesmoke">{{ __('Password') }}</label>
